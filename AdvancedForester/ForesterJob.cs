...
namespace AdvancedForester
{
    public class ForesterJob : AbstractAreaJob
    {
        ...
        public ForesterJob(AbstractAreaJobDefinition def, Colony owner, Vector3Int min, Vector3Int max, ItemTypes.ItemType sapling, int npcID = 0) : base(def, owner, min, max, npcID)
        {
            saplingTree = sapling;
        }
        ...
        public override void OnNPCAtJob(ref NPCBase.NPCState state)
        {
            ...
            else if (type == BuiltinBlocks.Types.air)
            {
                ...
                {
                    if (typeBelow.IsFertile && saplingTree != null)
                    {
